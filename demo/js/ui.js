...
function FileProgress(file, targetID) {
    ...
    if (!this.fileProgressWrapper.length) {
        ...
        //   </div>
        // </div>
        // _.template('<tr id="<%= id %>" class="progressContainer" style="opacity: 1;">'
        ...
        //                 +'</div>'
        //             +'</div>'
        //             +'<a href="#" class="progressCancel" style="display: none;">'
        //             +'</a>'
        //             +'<div class="status text-left" style="display: none;">'
        //                 + '已上传: '+<%= size %>+'上传速度：'+ <%= speed %>
        //             +'</div>'
        //         +'</div>'
        //     +'</td>'
        ...
        // +='<tr id="<%= id %>" class="progressContainer" style="opacity: 1;">';
        //     +='<td class="progressName">';
        //             <%= name %>
        //         +='<div class="Wrapper default">';
        //             +='<div class="imgWrapper col-md-3">';
